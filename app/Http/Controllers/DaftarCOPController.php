...
class DaftarCOPController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $data = DaftarCOP::select(['id', 'seafare_code', 'nama_lengkap', 'jenis_sertifikat_cop', 'jenis_kelamin', 'email', 'no_telp']);

            return DataTables::of($data)
                ->addColumn('aksi', function ($row) {
                    $btn = '<div class="btn-group">
                            <a href="/report_pendaftar_diklat_cop_pdf/' . $row->id . '" class="btn btn-dark btn-sm">
                                <i class="fas fa-file-pdf"></i>
                            </a>
                            <a href="/data_pendaftar_diklat_cop/show/' . $row->id . '" class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="/data_pendaftar_diklat_cop/edit/' . $row->id . '" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="' . route('DaftarCOP.destroy', $row->id) . '" method="POST" style="display:inline;">
