    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body justify-content-between">
                ...
                <form action="{{ route('NilaiUjianLokal.update', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="perjanjian_internasional"
                                    name="perjanjian_internasional" value="{{ $data->perjanjian_internasional }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="praktek_service_document"
                                    name="praktek_service_document" value="{{ $data->praktek_service_document }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="praktek_radio_telephony"
                                    name="praktek_radio_telephony" value="{{ $data->praktek_radio_telephony }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
