...
@section('content')
    <p>
        Pendaftaran Perpanjangan Sertifikat GMDSS
    </p>
    ...
    <form action="{{ route('PerpanjangGMDSS.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="scan_foto_ijazah_laut" name="scan_foto_ijazah_laut" required>
        </div>

        <div class="form-group">
            <label for="scan_foto_masa_layar">Upload Scan/Foto Masa Layar</label>
            <input type="file" class="form-control" id="scan_foto_masa_layar" name="scan_foto_masa_layar" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="scan_foto_sertifikat_bst" name="scan_foto_sertifikat_bst"
                required>
        </div>
