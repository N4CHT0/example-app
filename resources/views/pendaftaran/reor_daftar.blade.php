...
@section('content')
    ...
    <form action="{{ route('DaftarREOR.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="scan_foto_ijazah_terakhir" name="scan_foto_ijazah_terakhir"
                required>
        </div>
