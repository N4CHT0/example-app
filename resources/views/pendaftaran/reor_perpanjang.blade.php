...
@section('content')
    <p>
        Pendaftaran Perpanjangan Sertifikat REOR
    </p>

    <form action="{{ route('PerpanjangREOR.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="scan_foto_ijazah" name="scan_foto_ijazah" required>
        </div>

        <div class="form-group">
            <label for="scan_foto_sertifikat">Upload Scan/Foto Sertifikat</label>
            <input type="file" class="form-control" id="scan_foto_sertifikat" name="scan_foto_sertifikat" required>
        </div>
