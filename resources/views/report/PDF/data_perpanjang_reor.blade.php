...
<head>
    ...
    <title>Data Pendaftar Perpanjangan Sertifikat REOR</title>
</head>

<body>
    <h1>Data Pendaftar Perpanjangan Sertifikat REOR</h1>
    <div class="col-12">
        <div class="card">
            <div class="card-body justify-content-between">
                ...
                <div class="form-group">
                    ...
                    <img class="detail-value" id="scan_foto_ijazah"
                        src="{{ storage_path('app/public/img/' . $data->scan_foto_ijazah) }}" alt="Foto"
                        style="max-width: 300px;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <img class="detail-value" id="scan_foto_sertifikat"
                        src="{{ storage_path('app/public/img/' . $data->scan_foto_sertifikat) }}" alt="Foto"
                        style="max-width: 300px;">
                </div>
            </div>
        </div>
